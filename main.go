...
func main() {
	...
	movies = append(movies, Movie{ID: "1", Isbn: "123123", Title: "Movie the one", Director: &Director{Firstname: "Shaun", Lastname: "Wow"}})
	movies = append(movies, Movie{ID: "2", Isbn: "234234", Title: "Movie the Two", Director: &Director{Firstname: "Steve", Lastname: "Choco"}})
